...
class DirectDebitSepaPaymentMethod extends AbstractPaymentMethod
{
    ...
    {
        $title = $this->configRepo->get('wallee.directdebitsepa_title');
        if (! empty($title)) {
            return $title;
        } else {
    ...
    {
        $title = $this->configRepo->get('wallee.directdebitsepa_description');
        if (! empty($title)) {
            return $title;
        } else {
            return '';
    ...
    {
        $iconUrl = $this->configRepo->get('wallee.directdebitsepa_icon_url');
        if (!empty($iconUrl)) {
            return $iconUrl;
        } else {
