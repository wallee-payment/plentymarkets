...
class PaydirektPaymentMethod extends AbstractPaymentMethod
{
    use Loggable;
    ...
    public function getName(): string
    {
        ...
        $title = $translator->trans('wallee::Payment.PaydirektTitle');
        if (! empty($title)) {
            return $title;
        } else {
            return 'Paydirekt';
    ...
    public function getDescription(): string
    {
        ...
        $title = $translator->trans('wallee::Payment.PaydirektDescription');
        if (! empty($title)) {
            return $title;
        } else {
            return '';
    ...
    public function getIcon(): string
    {
        ...
        $iconUrl = $translator->trans('wallee::Payment.PaydirektIconUrl');
        if (!empty($iconUrl)) {
            return $iconUrl;
        } else {
