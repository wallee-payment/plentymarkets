...
class PayPalPaymentMethod extends AbstractPaymentMethod
{
    ...
    public function getName(): string
    {
        ...
        $title = $translator->trans('wallee::Payment.PayPalTitle');
        if (! empty($title)) {
            return $title;
        } else {
            return 'PayPal';
    ...
    public function getDescription(): string
    {
        ...
        $title = $translator->trans('wallee::Payment.PayPalDescription');
        if (! empty($title)) {
            return $title;
        } else {
            return '';
    ...
    public function getIcon(): string
    {
        ...
        $iconUrl = $translator->trans('wallee::Payment.PayPalIconUrl');
        if (!empty($iconUrl)) {
            return $iconUrl;
        } else {
